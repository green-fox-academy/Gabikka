...
void draw()
{
    ...
    SDL_SetRenderDrawColor(gRenderer, 0x00, 0xf5, 0x00, 255);
    SDL_RenderDrawLine(gRenderer, 220, 100, 420, 100);

    SDL_SetRenderDrawColor(gRenderer, 0xff, 0x00, 0x00, 255);
    SDL_RenderDrawLine(gRenderer, 420, 100, 420, 340);

    SDL_SetRenderDrawColor(gRenderer, 0x00, 0x00, 0x66, 255);
    SDL_RenderDrawLine(gRenderer, 220, 340, 420, 340);

    SDL_SetRenderDrawColor(gRenderer, 0xff, 0xff, 0x00, 255);
    SDL_RenderDrawLine(gRenderer, 220, 100, 220, 340);
}
